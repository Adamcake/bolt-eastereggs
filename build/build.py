...
tempfilename = "bolt-eastereggs-{}.tar.zst".format(releasetitle)
...
with open(tempfile, 'wb') as f:
    args = ["lua", "{}/archive.lua".format(scriptdir), "{}/".format(basedir), "{}/bolt.json".format(basedir), "{}/main.lua".format(basedir)]
...
with open(metafile, "w") as f:
    f.write(json.dumps({"sha256": filehash, "version": version, "url": "https://github.com/Adamcake/bolt-eastereggs/releases/download/{}/{}".format(version, tempfilename)}))
